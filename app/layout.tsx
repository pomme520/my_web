    ...
    <html lang="zh-Hant">
      <body>
        <div className="min-h-screen bg-slate-100 text-slate-800">
          ...
          <header className="border-b border-slate-200 bg-white"><div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-6 py-5 lg:px-12"><Link href="/" className="flex items-center gap-5" aria-label="台灣電力公司台東區營業處首頁"><img src="/tpclogo.svg" alt="台灣電力公司 Taiwan Power Company" className="h-20 w-auto shrink-0 object-contain md:h-24" /><div className="flex flex-col justify-center leading-[0.9] text-[#111111]"><span className="brand-chinese text-[clamp(2rem,2.6vw,3.4rem)] font-black tracking-[-0.05em]">台東區營業處</span><span className="mt-1 text-[clamp(1.05rem,1.5vw,2rem)] font-semibold tracking-[0.08em] text-[#111111]">TAIWAN POWER COMPANY</span></div></Link><Link href="/booking" className="rounded-md bg-blue-700 px-4 py-2.5 text-sm font-bold text-white shadow-sm transition hover:bg-blue-800">線上報修</Link></div></header>
